...
function start(){loadScript('document-preview.js?v=20260827-03','pcm-document-preview-loader');loadScript('hadits-fix.js?v=20260827-01','pcm-hadits-fix-loader');loadScript('hadits-reader-tools.js?v=20260827-01','pcm-hadits-reader-tools-loader');dedupePrayer();const observer=new MutationObserver(()=>dedupePrayer());observer.observe(document.body,{childList:true,subtree:true})}
